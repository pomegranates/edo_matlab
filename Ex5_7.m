...
P = InterX([x;y1],[x;y2]);
plot([0 70], [P(1,1) P(1,1)],'Color',[0 0.6 0],'LineWidth',2);
plot([0 70], [P(1,2) P(1,2)],'-r','LineWidth',2);
plot([0 70], [P(1,3) P(1,3)],'Color',[0 0.6 0],'LineWidth',2);
...
y2 = r*x.*(1-(x./k)) - (x.*x./(1+x.*x));
P = InterX([x;y1],[x;y2]);
plot([0 100], [P(1,1) P(1,1)],'Color',[0 0.6 0],'LineWidth',2);
plot([0 100], [P(1,2) P(1,2)],'-r','LineWidth',2);
plot([0 100], [P(1,3) P(1,3)],'Color',[0 0.6 0],'LineWidth',2);
